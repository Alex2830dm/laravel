...
class CreateCitasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('citas', function (Blueprint $table) {
            ...
            $table->enum('estatus', ['pendiente', 'atentida', 'cancelada'])->comment('Tipo Cita');
            $table->string('telefono_contacto', 15)->comment('Telefono Contacto');
            $table->string('dcalle', 60)->comment('Direccion Calle');
            $table->string('dcolonia', 60)->comment('Direccion Colonia');
            $table->string('dlocalidad', 60)->comment('Direccion Localidad');
            $table->string('dmunicipio', 60)->comment('Direccion Municipio');            
