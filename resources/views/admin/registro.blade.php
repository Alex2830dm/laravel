      ...
      <form action="{{url('admin/registrar')}}" method="post" enctype="multipart/form-data">        
        <table>
          ...
          <tr>
            ...
            <td><input type="text" name="apm" id="apm" class="form-control"></td> 
            <td><span id="sapm" class="sapm"></span></td>
          </tr>
          <tr>
            <td>Telefono: </td>
            <td><input type="text" name="telefono" id="nombre" class="form-control"></td>
            <td>Perfil: </td>
            <td>
          ...
          <tr>
            ...
            <td>Password</td>
            <td><input type="password" name="password" id="pass1" class="form-control"></td>
