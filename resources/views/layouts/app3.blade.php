...
<head>
  ...
  <title>Healthcare System | Medico</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('medico/emergencias')}}" class="nav-link">
                  <p>Emergencias</p>
                </a>
              </li>
            </ul>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('medico/doctores')}}" class="nav-link">
                  <p>Doctores</p>                    
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('medico/agenda')}}" class="nav-link">
                  <p>Agenda</p>                    
                </a>
              </li>
              <li class="nav-item">
