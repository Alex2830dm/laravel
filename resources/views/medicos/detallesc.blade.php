...
<div class="container">    
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-2">
                Estatus:
                <input type="text" id="estatus" name="estatus" value="{{$datos->estatus}}" class="form-control" readonly>                
            </div>
            <div class="col-4">
        ...
        <div class="row">
            <div class="col-8">
                Dirección de Consulta: <input type="text" name="direccion_calle" class="form-control" id="d1" value="{{$datos->dcalle}} {{$datos->dcolonia}} {{$datos->dlocalidad}} {{$datos->dmunicipio}}" readonly>
            </div>
        </div>        
        <div class="row">
            <div class="col-8">
        ...
        <div class="row">
            <div class="col-8">
                Observaciones:
                <textarea name="observaciones" id="observacioness" cols="5" rows="" class="form-control" readonly>{{$datos->observaciones}}</textarea>
            </div>
        </div>
        <br><hr>        
        <div class="row">
            <div class="col-4">
                <a href="{{url('medico/historial/'.$datos->id_usuario)}}">
            ...
            <div class="col-4">
                <a href="{{url('medico/modificar_cita/'.$datos->id_cita)}}">
