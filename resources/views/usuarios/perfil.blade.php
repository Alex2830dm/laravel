...
<head>
  ...
  <title>Healthcare System | Usuario</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="{{asset('img/'.$perfil->foto)}}" class="img-circle elevation-2" alt="User Image">
        </div>    
        <div class="info">
            <a href="{{url('usuario/perfil')}}" class="d-block">
                {{ $perfil->nombre }}
            </a>
        </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{url('usuario/emergencias')}}" class="nav-link">
                    <p>Emergencias</p>
                  </a>
                </li>
              </ul>
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{url('usuario/doctores')}}" class="nav-link">
                    <p>Doctores</p>                    
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{url('usuario/historial/1')}}" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{$perfil->id_usuario}}: {{$perfil->nombre}} </h1>
          </div><!-- /.col -->          
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>    
...
<div class="container-sm">   
    ...
    <div class="row justify-content-center">
        <div class="col-4">
            <a href="{{url('usuario/modificar/'.$perfil->id_usuario ) }}">                
